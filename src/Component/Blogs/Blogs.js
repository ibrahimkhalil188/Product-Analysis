...
const Blogs = () => {
    return (
        <div className='grid grid-cols-2'>
            <div className='p-20'>
                <h1 className='text-5xl text-cyan-600 font-bold my-6'>What is semantic tag?</h1>
            ...
            <div className='p-20'>
                <h1 className='text-5xl text-cyan-600 font-bold my-6'>What is context API ?</h1>
            ...
            <div className='p-20'>
                <h1 className='text-5xl text-cyan-600 font-bold my-6'>What is inline , block and inline-block element?</h1>
                <p className='text-2xl p-2'>

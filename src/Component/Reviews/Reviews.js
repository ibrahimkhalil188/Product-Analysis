...
const Reviews = () => {
    ...
    return (
        ...
        <div className='bg-slate-900'>
            ...
            <div className='grid md:grid-cols-3 text-2xl gap-4 ' >
                {
                    (reviews).map(review =>
                        <div className='p-6' key={review.id} >
                            ...
                            <div className='bg-emerald-500 relative h-[180px]'>
                                <img className='w-32 h-32 rounded-full absolute top-[-60px] md:left-[140px] left-[85px] border-4' src={review.image} alt="" />
                                <div className='absolute top-20 md:left-[140px] left-[85px]'>
                                    <h1>{review.name}</h1>
